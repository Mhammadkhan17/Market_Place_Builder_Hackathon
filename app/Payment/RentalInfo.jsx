...
const RentalInfo = ({ formData, onInputChange }) => {
  return (
    <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-4">
              <div>
                ...
                <select
                  ...
                  onChange={(e) => onInputChange("rentalInfo", `${type}.location`, e.target.value)}
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => onInputChange("rentalInfo", `${type}.date`, e.target.value)}
                  className="mt-1 block w-full rounded-md border-gray-300 bg-gray-50 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm px-6 py-3"
                  required
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => onInputChange("rentalInfo", `${type}.time`, e.target.value)}
                  className="mt-1 block w-full rounded-md border-gray-300 bg-gray-50 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm px-6 py-3"
                  required
                />
              </div>
